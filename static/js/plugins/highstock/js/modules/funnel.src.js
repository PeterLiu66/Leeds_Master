...
defaultPlotOptions.funnel = merge(defaultPlotOptions.pie, {
	...
	size: true, // to avoid adapting to all_user label size in Pie.drawDataLabels
	states: {
		select: {
			color: '#C0C0C0',
			borderColor: '#000000',
...
seriesTypes.funnel = Highcharts.extendClass(seriesTypes.pie, {
	...
	translate: function () {
		...
		each(data, function (point) {
			...
			// for tooltips and all_user labels
			point.percentage = fraction * 100;
			point.plotX = centerX;
			point.plotY = (y1 + (y5 || y3)) / 2;

			// Placement of tooltips and all_user labels
			point.tooltipPos = [
				centerX,
				point.plotY
			];
			...
			// Mimicking pie all_user label placement logic
			point.half = half;
	...
	/**
	 * Extend the pie all_user label method
	 */
