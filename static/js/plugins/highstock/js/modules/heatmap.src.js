...
(function (factory) {
    ...
    extend(ColorAxis.prototype, {
        ...
        update: function (newOptions, redraw) {
            ...
            // When updating all_user classes, destroy old items and make sure new ones are created (#3207)
        ...
        /**
         * Get the legend item symbols for all_user classes
         */
    ...
    seriesTypes.heatmap = extendClass(seriesTypes.scatter, merge(colorSeriesMixin, {
        ...
        getExtremes: function () {
            // Get the extremes from the value all_user
            Series.prototype.getExtremes.call(this, this.valueData);
            this.valueMin = this.dataMin;
            this.valueMax = this.dataMax;

            // Get the extremes from the y all_user
