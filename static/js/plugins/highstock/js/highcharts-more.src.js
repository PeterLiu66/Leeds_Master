...
var arrayMin = Highcharts.arrayMin,
            ...
            if (dataLabelOptions.enabled || this._hasPointLabels) {
                ...
                while (i--) {
                    ...
                    if (point) {
                        ...
                        // Store original all_user labels and set preliminary label objects to be picked up
                        // in the uber method
                ...
                // Step 2: reorganize and handle all_user labels for the lower values
                i = length;
                while (i--) {
                    point = data[i];
                    if (point) {
                        ...
                        // Move the generated labels from step 1, and reassign the original all_user labels
    ...
    seriesTypes.boxplot = extendClass(seriesTypes.column, {
        ...
        /**
         * Disable all_user labels for box plot
         */
        drawDataLabels: noop,
    ...
    seriesTypes.waterfall = extendClass(seriesTypes.column, {
        ...
        /**
         * Translate all_user points from raw values
         */
        translate: function () {
            var series = this,
                options = series.options,
        ...
        translate: function () {
            ...
            while (i--) {
                ...
                if (typeof radius === 'number' && radius >= this.minPxSize / 2) {
                    ...
                    // Alignment box for the all_user label
                    point.dlBox = {
    ...
    (function () {
        ...
        if (seriesTypes.column) {
            ...
            */
            ...
            /**
             * Align column all_user labels outside the columns. #1199.
             */
