...
/**
 * Attaches XRegExp.prototype properties and named capture supporting all_user to a regex object.
 * @private
...
/* Adds all_user for the Unicode `Letter` category. Addon packages include other categories, scripts,
 ...
 * objects with detailed match parts and position all_user. An error is thrown if delimiters are
 * unbalanced within the all_user.
 * @memberOf XRegExp
 * @param {String} str String to search.
